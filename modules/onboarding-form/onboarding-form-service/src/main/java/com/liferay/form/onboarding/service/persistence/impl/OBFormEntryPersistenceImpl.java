...
public class OBFormEntryPersistenceImpl
	 ...
	 */
	@Override
	public List<OBFormEntry> filterFindBygroupId(long groupId) {
	 ...
	 */
	@Override
	public List<OBFormEntry> filterFindBygroupId(
		long groupId, int start, int end) {
	...
	public List<OBFormEntry> filterFindBygroupId(
		...
		if (getDB().isSupportsInlineDistinct()) {
			sb.append(_FILTER_SQL_SELECT_OBFORMENTRY_WHERE);
		}
		else {
			sb.append(
				_FILTER_SQL_SELECT_OBFORMENTRY_NO_INLINE_DISTINCT_WHERE_1);
		}
		...
		if (!getDB().isSupportsInlineDistinct()) {
			sb.append(
				_FILTER_SQL_SELECT_OBFORMENTRY_NO_INLINE_DISTINCT_WHERE_2);
		}
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				sb.append(OBFormEntryModelImpl.ORDER_BY_SQL);
			}
		}

		String sql = InlineSQLHelperUtil.replacePermissionCheck(
			sb.toString(), OBFormEntry.class.getName(),
		...
		try {
			...
			if (getDB().isSupportsInlineDistinct()) {
				sqlQuery.addEntity(_FILTER_ENTITY_ALIAS, OBFormEntryImpl.class);
			}
			else {
				sqlQuery.addEntity(_FILTER_ENTITY_TABLE, OBFormEntryImpl.class);
			}
			...
			return (List<OBFormEntry>)QueryUtil.list(
	...
	protected OBFormEntry filterGetBygroupId_PrevAndNext(
		Session session, OBFormEntry obFormEntry, long groupId,
		OrderByComparator<OBFormEntry> orderByComparator, boolean previous) {
		...
		List<OBFormEntry> list = sqlQuery.list();
	...
	public int filterCountBygroupId(long groupId) {
		...
		sb.append(_FILTER_SQL_COUNT_OBFORMENTRY_WHERE);
	 ...
	 */
	@Override
	public List<OBFormEntry> filterFindByn_g(long groupId, String name) {
		return filterFindByn_g(
			groupId, name, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<OBFormEntry> filterFindByn_g(
		long groupId, String name, int start, int end) {

		return filterFindByn_g(groupId, name, start, end, null);
	}
	...
	public List<OBFormEntry> filterFindByn_g(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByn_g(groupId, name, start, end, orderByComparator);
		}
	...
	public OBFormEntry[] filterFindByn_g_PrevAndNext(
		...
		try {
			...
			array[0] = filterGetByn_g_PrevAndNext(
				session, obFormEntry, groupId, name, orderByComparator, true);

			array[1] = obFormEntry;

			array[2] = filterGetByn_g_PrevAndNext(
				session, obFormEntry, groupId, name, orderByComparator, false);
	...
	protected OBFormEntry filterGetByn_g_PrevAndNext(
		Session session, OBFormEntry obFormEntry, long groupId, String name,
		OrderByComparator<OBFormEntry> orderByComparator, boolean previous) {
	...
	public int filterCountByn_g(long groupId, String name) {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByn_g(groupId, name);
		}
	...
	private static final String _FILTER_ENTITY_TABLE_FILTER_PK_COLUMN =
		"obFormEntry.obFormEntryId";

	private static final String _FILTER_SQL_SELECT_OBFORMENTRY_WHERE =
		"SELECT DISTINCT {obFormEntry.*} FROM OBForm_OBFormEntry obFormEntry WHERE ";

	private static final String
		_FILTER_SQL_SELECT_OBFORMENTRY_NO_INLINE_DISTINCT_WHERE_1 =
			"SELECT {OBForm_OBFormEntry.*} FROM (SELECT DISTINCT obFormEntry.obFormEntryId FROM OBForm_OBFormEntry obFormEntry WHERE ";

	private static final String
		_FILTER_SQL_SELECT_OBFORMENTRY_NO_INLINE_DISTINCT_WHERE_2 =
			") TEMP_TABLE INNER JOIN OBForm_OBFormEntry ON TEMP_TABLE.obFormEntryId = OBForm_OBFormEntry.obFormEntryId";

	private static final String _FILTER_SQL_COUNT_OBFORMENTRY_WHERE =
		"SELECT COUNT(DISTINCT obFormEntry.obFormEntryId) AS COUNT_VALUE FROM OBForm_OBFormEntry obFormEntry WHERE ";

	private static final String _FILTER_ENTITY_ALIAS = "obFormEntry";

	private static final String _FILTER_ENTITY_TABLE = "OBForm_OBFormEntry";

	private static final String _ORDER_BY_ENTITY_ALIAS = "obFormEntry.";

	private static final String _ORDER_BY_ENTITY_TABLE = "OBForm_OBFormEntry.";
