...
@Component(
	...
	property = {
		...
		"mvc.command.name=/onboarding_form/create_entry"
	},
	service = MVCRenderCommand.class
)
public class CreateEntryMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(
		...
		return "/onboarding_form/edit_entry_form.jsp";
	}
